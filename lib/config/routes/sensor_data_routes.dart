...
import 'package:irrigation_app/modules/farmer/available_sensor_listView.dart';
...
class SensorDataRoutes extends TbRoutes {
  ...
  late var sensorListHandler = Handler(handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
    return AvailableSensorListView(tbContext, customerId: '',);
  });
  ...
  void doRegisterRoutes(router) {
    ...
    router.define("/available_sensor", handler: sensorListHandler);
